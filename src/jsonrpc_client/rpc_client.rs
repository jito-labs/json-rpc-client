...
///
/// The client should be used with jito block engine proxy server for authentication
///
...
impl RpcClient {
    ...
    ///     .collect();
    ///
    /// let rpc_client = RpcClient::new(PROXY_SERVER_URL.to_owned());
    ...
    /// use jito_block_engine_json_rpc_client::jsonrpc_client::rpc_client::RpcClient;
    ///
    /// let PROXY_SERVER_URL = "http://localhost:8899";
...
mod rpc_client_tests {
    ...
    const PROXY_SERVER_URL: &str = "http://0.0.0.0:8080/api/v1/bundles";
